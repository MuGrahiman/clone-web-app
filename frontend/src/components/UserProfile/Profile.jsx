...
export default function Profile() {
  ...
  const addImage = async (e) => {
    ...
    await axios
      .post(`http://localhost:8000/upload/${AuthId._id}`, formData, config)
      .then((res) => {
          ...
          <div className="card-body text-center">
            <img
              src={
                ...
                upload.image ? `http://localhost:8000/images/${upload.image}` :  "https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava3.webp"
